...
export default async function SubjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="subject-page">
    <header className="article-header"><Link className="brand" href="/"><BrandLogo /><span><b>HỒNG VIỆT</b><small>SÁO TRÚC & ÂM NHẠC DÂN TỘC</small></span></Link><nav><Link href="/">Trang chủ</Link><Link href="/#classes">Các bộ môn</Link><Link href="/#contact">Liên hệ</Link></nav></header>
    ...
    <footer><Link className="brand" href="/"><BrandLogo /><span><b>HỒNG VIỆT</b><small>SÁO TRÚC & ÂM NHẠC DÂN TỘC</small></span></Link><p>Đam mê làm nên giá trị · Chất lượng tạo nên uy tín</p><small>© 2026 Hồng Việt.</small></footer>
  </main>;
}
