...
const exactPhraseMap: Record<string, string> = {
  ...
  "Đăng ký bộ môn or Tư vấn dịch vụ, sản phẩm": "Course Enrollment or Service & Product Consultation",
  "Đăng ký bộ môn / Tư vấn dịch vụ, sản phẩm": "Course Enrollment or Service & Product Consultation",
  "(Bấm để chọn tích một hoặc nhiều mục cùng lúc)": "(Click to select one or multiple options)",
  "Mua sáo & phụ kiện": "Buy Flute & Accessories",
  "Khóa học video quay sẵn": "Pre-recorded Video Courses",
  "Sheet nhạc & giáo trình": "Sheet Music & Curriculum",
  "Thu âm & quay MV": "Audio Recording & MV Production",
  "Booking biểu diễn": "Artist Booking for Events",
