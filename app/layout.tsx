...
export const metadata: Metadata = {
  ...
  keywords: [
    "sáo trúc âu cơ",
    "sao truc au co",
    "học sáo trúc cho người mới bắt đầu",
    "học sáo trúc từ con số 0",
    "học sáo trúc tphcm",
    "lớp học sáo trúc tphcm",
    "lớp học sáo trúc tân phú",
    "học sáo trúc online 1 kèm 1",
    "học sáo trúc online",
    "dạy thổi sáo tại tphcm",
    "dạy thổi sáo",
  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        {
          "@type": "Question",
          name: "Học phí học sáo trúc tại Sáo Trúc Âu Cơ là bao nhiêu?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Học phí tại Sáo Trúc Âu Cơ được tối ưu theo từng khóa học (1 kèm 1 trực tiếp tại lớp, gia sư tại nhà hoặc online qua video call). Học viên được xếp lịch linh hoạt, có chính sách bảo lưu buổi học khi bận và được hỗ trợ sáo tập tại lớp.",
          },
        },
        {
          "@type": "Question",
          name: "Người mới bắt đầu nên chọn học loại sáo nào dễ nhất?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Người mới bắt đầu thường dễ tiếp cận nhất với Sáo Trúc Việt Nam tone Đô (C5) hoặc tone La trầm (A4), hoặc sáo dọc Recorder. Đây là các dòng sáo có khoảng cách ngón tay vừa phải, luồng hơi dễ kiểm soát và tài liệu cảm âm phong phú.",
          },
        },
      ],
    },
  ...
  return (
    <html lang="vi">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Be+Vietnam+Pro:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400;1,600&family=Cinzel:wght@600;700&family=Great+Vibes&family=Playfair+Display:ital,wght@0,500;0,600;0,700;0,800;1,500;1,600;1,700&display=swap" rel="stylesheet" />
