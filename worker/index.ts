...
const detailedCmsEntries = [
  ...
  ["home-intro-01", "home-intro", "Người Sáng Lập Sáo Trúc Âu Cơ – Thầy Quách Hạ Văn", "gioi-thieu-nha-sang-lap", "Hơn 8 năm tâm huyết nghiên cứu, giảng dạy và lan tỏa nghệ thuật sáo trúc Việt Nam. Thông tin giới thiệu chi tiết về Người sáng lập đang được cập nhật.", "/intro-portrait.jpg", "Mỗi người đều có thể thổi được những giai điệu đẹp chỉ cần bắt đầu đúng cách.", "Giới thiệu nhà sáng lập", "/gioi-thieu-admin", 1],

  // Trang giới thiệu Người sáng lập (/gioi-thieu-admin)
  ["founder-intro-01", "founder-intro", "Người Sáng Lập Sáo Trúc Âu Cơ – Thầy Quách Hạ Văn", "gioi-thieu-admin", "Nội dung giới thiệu chi tiết về Người sáng lập Sáo Trúc Âu Cơ đang được cập nhật.", "/intro-portrait.jpg|/hero-artist.jpg", "dang-cap-nhat", "0374 261 368", "Thầy Quách Hạ Văn\nChủ nhiệm & Người sáng lập Sáo Trúc Âu Cơ\n106/72 Hoà Bình, P. Tân Phú, TP.HCM\nHotline/Zalo: 0374 261 368\nEmail: saotrucauco@gmail.com\n“Mỗi người đều có thể thổi được những giai điệu đẹp chỉ cần bắt đầu đúng cách.”", 1],
